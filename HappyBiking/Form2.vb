Public Class Form2
    Dim pre_next_page As Integer = 1
    ...
    Private Sub PictureBox2_Click(sender As Object, e As EventArgs) Handles PreviousPage.Click
        If pre_next_page <> 1 Then
            pre_next_page = pre_next_page - 1
            If pre_next_page = 1 Then
                Topic.Text = topic1
                Content.Text = content1
            ElseIf pre_next_page = 2 Then
                Topic.Text = topic2
                Content.Text = content2
            ElseIf pre_next_page = 3 Then
                Topic.Text = topic3
    ...
    Private Sub PictureBox3_Click(sender As Object, e As EventArgs) Handles NextPage.Click
        If pre_next_page <> 4 Then
            pre_next_page = pre_next_page + 1
            If pre_next_page = 2 Then
                Topic.Text = topic2
                Content.Text = content2
            ElseIf pre_next_page = 3 Then
                Topic.Text = topic3
                Content.Text = content3
            ElseIf pre_next_page = 4 Then
                Topic.Text = topic4
